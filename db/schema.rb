...
ActiveRecord::Schema.define(version: 2019_03_06_131826) do

ActiveRecord::Schema.define(version: 2019_03_06_151819) do
  ...
  create_table "liked_articles", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["article_id"], name: "index_liked_articles_on_article_id"
